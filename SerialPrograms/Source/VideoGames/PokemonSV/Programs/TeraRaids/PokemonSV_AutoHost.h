...
#include "VideoGames/PokemonSV/Options/PokemonSV_TeraAIOption.h"
#include "VideoGames/PokemonSV/Options/PokemonSV_AutoHostOptions.h"
...
public:
    using Descriptor = AutoHost_Descriptor;
    AutoHost();
