...
#include "VideoGames/PokemonSwSh/MaxLair/Program/PokemonSwSh_MaxLair_Run_Start.h"
...
AdventureResult run_adventure(
    ...
    GlobalStateTracker state_tracker(scope, env.consoles());

    if (!start_adventure(
        env, scope,
        state_tracker,
        entrance,
        env.console(runtime.host_index), boss_slot,
