...
#include "VideoGames/PokemonFRLG/Programs/RngManipulation/PokemonFRLG_BlindNavigation.h"
...
double get_advances_calibration(const RngCalibrationHistory& calibration_history, uint64_t advances);
