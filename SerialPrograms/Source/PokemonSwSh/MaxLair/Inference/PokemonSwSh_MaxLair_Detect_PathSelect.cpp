...
void PathReader::read_path(ProgramEnvironment& env, BotBaseContext& context, ConsoleHandle& console, GlobalState& state){
    PathMap path;
    if (MaxLairInternal::read_path(env, context, console, path, m_path)){
