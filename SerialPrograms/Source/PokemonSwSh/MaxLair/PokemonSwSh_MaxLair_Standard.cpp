...
MaxLairStandard_Descriptor::MaxLairStandard_Descriptor()
    : MultiSwitchProgramDescriptor(
        ...
        "SwSh-Arduino/wiki/Advanced:-MaxLair-Standard",
...
bool MaxLairStandard::is_valid() const{
...
void MaxLairStandard::program(MultiSwitchProgramEnvironment& env){
    ...
    CaughtScreenAction end_action = STOP_CONDITION == 0
        ? CaughtScreenAction::TAKE_NON_BOSS_STOP_ON_SHINY_BOSS
        : CaughtScreenAction::TAKE_NON_BOSS_STOP_ON_NOTHING;
    ...
    do{
        ...
        start_raid(env, state_tracker, entrance, host, BOSS_SLOT + 1, code);
