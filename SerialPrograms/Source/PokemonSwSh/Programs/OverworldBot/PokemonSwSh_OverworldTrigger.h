...
public:
    ...
    virtual void run(BotBaseContext& context) = 0;

protected:
    void whistle(BotBaseContext& context, bool rotate);
...
public:
    ...
    virtual void run(BotBaseContext& context) override;
...
protected:
    virtual void action(BotBaseContext& context) = 0;

private:
    void whistle_loop(BotBaseContext& context);
    void action_loop(BotBaseContext& context);
...
public:
    ...
    virtual void action(BotBaseContext& context) override;
};
