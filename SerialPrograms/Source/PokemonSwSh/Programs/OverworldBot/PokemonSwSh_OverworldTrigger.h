...
public:
    ...
    virtual void run(ControllerContext& context) = 0;

protected:
    void whistle(ControllerContext& context, bool rotate);
...
public:
    ...
    virtual void run(ControllerContext& context) override;
...
protected:
    virtual void action(ControllerContext& context) = 0;

private:
    void whistle_loop(ControllerContext& context);
    void action_loop(ControllerContext& context);
...
public:
    ...
    virtual void action(ControllerContext& context) override;
};
