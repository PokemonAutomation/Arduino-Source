    ...
    //  Wait for game to load.
    {
        ...
        while (true){
            ...
            if (screen.isNull()){
                ...
                bool black0 = is_black(extract_box_shallow(screen, box0));
                bool black1 = is_black(extract_box_shallow(screen, box1));
                if (black0 && black1){
                    if (!black_found){
    ...
    //  Wait to enter game.
    {
        ...
        while (true){
            ...
            if (screen.isNull()){
                ...
                bool black = is_black(extract_box_shallow(screen, box));
                if (black){
                    if (!black_found){
