...
StatsResetCalyrex_Descriptor::StatsResetCalyrex_Descriptor()
    : RunnableSwitchProgramDescriptor(
        ...
        "Stats Reset - Calyrex",
        "SwSh-Arduino/wiki/Advanced:-StatsResetCalyrex",
...
void StatsResetCalyrex::program(SingleSwitchProgramEnvironment& env){
    ...
    while (!match_found){
        ...
        while (!calyrex_caught){
            ...
            env.update_stats();
            QString message = "Threw " + QString::number(result.balls_used) + " balls " + (calyrex_caught ? "and caught it" : "and did not caught it");
