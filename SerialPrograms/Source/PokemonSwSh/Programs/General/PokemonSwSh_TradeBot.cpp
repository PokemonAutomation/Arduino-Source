...
void TradeBot::trade_slot(
    ...
    ssf_press_button(context, BUTTON_A, 200, 20);
    if (LINK_TRADE_EXTRA_LINE){
        ssf_press_button(context, BUTTON_B, 50, 20);
    }
    ssf_press_button(context, BUTTON_B, 200, 20);
    ssf_press_dpad(context, DPAD_UP, 10);
    ssf_press_button(context, BUTTON_A, 5);
    ssf_press_button(context, BUTTON_B, 5);

    FastCodeEntry::numberpad_enter_code(console, context, code, true);
    ssf_press_button(context, BUTTON_PLUS, 200);
    ssf_press_button(context, BUTTON_B, 125, 10);
    ssf_press_button(context, BUTTON_A, 50, 10);
    ...
    ssf_press_button(context, BUTTON_Y, GameSettings::instance().OPEN_YCOMM_DELAY0, 400ms);
    ssf_press_button(context, BUTTON_A, 200, 20);
    ssf_press_button(context, BUTTON_B, 80, 10);
...
void TradeBot::program(SingleSwitchProgramEnvironment& env, ProControllerContext& context){
    ...
    for (uint8_t box = 0; box < BOXES_TO_TRADE; box++){
        ...
        for (uint8_t c = 0; c < 2; c++){
            ssf_press_button(context, BUTTON_Y, 250);
            ssf_press_button(context, BUTTON_A, 280);
            ssf_press_button(context, BUTTON_B, 280);
            ssf_press_button(context, BUTTON_B, 200);
            ssf_press_button(context, BUTTON_A, 100);
