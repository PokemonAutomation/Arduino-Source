...
void TradeBot::trade_slot(ControllerContext& context, const uint8_t code[8], uint8_t slot) const{
...
void TradeBot::program(SingleSwitchProgramEnvironment& env, ControllerContext& context){
    uint8_t code[8];
