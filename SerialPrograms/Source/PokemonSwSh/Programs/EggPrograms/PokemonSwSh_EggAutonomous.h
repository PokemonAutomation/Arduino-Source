...
private:
    ...
    bool run_batch(SingleSwitchProgramEnvironment& env, BotBaseContext& context, EggAutonomous_Descriptor::Stats& stats);

    void save_game(SingleSwitchProgramEnvironment& env, BotBaseContext& context);
    ...
    void call_flying_taxi(SingleSwitchProgramEnvironment& env, BotBaseContext& context, bool fly_from_overworld);
    ...
    void wait_for_egg_hatched(SingleSwitchProgramEnvironment& env, BotBaseContext& context, EggAutonomous_Descriptor::Stats& stats, size_t num_hatched_eggs);
    ...
    size_t talk_to_lady_to_fetch_egg(SingleSwitchProgramEnvironment& env, BotBaseContext& context, EggAutonomous_Descriptor::Stats& stats, size_t num_eggs_retrieved);
