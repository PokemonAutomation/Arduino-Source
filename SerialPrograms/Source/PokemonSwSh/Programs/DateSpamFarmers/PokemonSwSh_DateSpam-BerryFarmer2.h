...
private:
    Rustling check_rustling(SingleSwitchProgramEnvironment& env, ControllerContext& context);
    uint16_t do_secondary_attempts(SingleSwitchProgramEnvironment& env, ControllerContext& context, Rustling last_rustling);
