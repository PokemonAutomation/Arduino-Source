...
DailyHighlightFarmer::DailyHighlightFarmer()
    : SingleSwitchProgram(
        ...
        "NativePrograms/DateSpam-DailyHighlightFarmer.md",
...
void DailyHighlightFarmer::program(SingleSwitchProgramEnvironment& env) const{
    ...
    for (uint32_t c = 0; c < SKIPS; c++){
        ...
        pbf_press_button(BUTTON_A, 10, 110);
        pbf_press_button(BUTTON_ZL, 10, 40);
        pbf_press_dpad(DPAD_DOWN, 10, 10);
        pbf_mash_button(BUTTON_ZL, 400);
