...
void EventBeamFinder::goto_near_den(ControllerContext& context) const{
...
void EventBeamFinder::goto_far_den(ControllerContext& context) const{
...
void EventBeamFinder::drop_wishing_piece(ControllerContext& context) const{
...
void EventBeamFinder::program(SingleSwitchProgramEnvironment& env, ControllerContext& context){
