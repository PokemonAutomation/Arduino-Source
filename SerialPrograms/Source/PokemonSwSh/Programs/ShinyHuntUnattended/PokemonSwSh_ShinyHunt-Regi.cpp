...
void regirock(ControllerContext& context){
...
void regice(ControllerContext& context){
...
void registeel(ControllerContext& context){
    pbf_move_left_joystick(context, 0, 232, 169, 0);
...
void regieleki(ControllerContext& context){
...
void regidrago(ControllerContext& context){
