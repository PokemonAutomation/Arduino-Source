...
//                    {shiny_detector},
            ...
            pbf_move_left_joystick_old1(context, 0x80, 0x00, 40, 5);     //  Move up a bit to avoid talking to your pokemon.
            pbf_press_button(context, BUTTON_A, 40ms, 40ms);
            pbf_move_left_joystick_old1(context, 0xff, 0x80, 55, 0);     //  Right
            for (uint16_t i = 0;  i< 2; i++){
                pbf_move_left_joystick_old1(context, 0x00, 0x80, 27, 0); //  Left
                pbf_press_button(context, BUTTON_A, 40ms, 40ms);
                pbf_move_left_joystick_old1(context, 0x00, 0x80, 27, 0); //  Left
                pbf_press_button(context, BUTTON_A, 40ms, 40ms);
                pbf_move_left_joystick_old1(context, 0x00, 0x80, 27, 0); //  Left
                ...
                pbf_move_left_joystick_old1(context, 0x00, 0x80, 27, 0); //  Left
                pbf_press_button(context, BUTTON_A, 40ms, 40ms);
                pbf_move_left_joystick_old1(context, 0xff, 0x80, 27, 0); //  Right
                pbf_press_button(context, BUTTON_A, 40ms, 40ms);
                pbf_move_left_joystick_old1(context, 0xff, 0x80, 27, 0); //  Right
                pbf_press_button(context, BUTTON_A, 40ms, 40ms);
                pbf_move_left_joystick_old1(context, 0xff, 0x80, 27, 0); //  Right
...
//                shininess = shiny_detector.results();
        ...
        pbf_move_left_joystick_old1(context, 0xff, 0x80, 125, 5);
        pbf_move_left_joystick_old1(context, 0x80, 0x00, 125, 5);
