...
void CurryHunter::program(SingleSwitchProgramEnvironment& env, const BotBaseContext& context){
...
//            );
            AsyncVisualInferenceSession inference(env, env.console, env.scope(), env.console, env.console);
