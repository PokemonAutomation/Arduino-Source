...
void resume_game_no_interact            (BotBaseContext& device, bool tolerate_update_menu);
void resume_game_back_out               (BotBaseContext& device, bool tolerate_update_menu, uint16_t mash_B_time);
