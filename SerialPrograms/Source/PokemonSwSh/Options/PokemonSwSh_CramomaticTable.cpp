...
CramomaticRow::CramomaticRow()
    : ball_type(BallType_Database(), LockWhileRunning::LOCKED, CramomaticBallType::Apricorn)
    , is_bonus(LockWhileRunning::LOCKED, false)
    , priority(LockWhileRunning::LOCKED, 0)
{
