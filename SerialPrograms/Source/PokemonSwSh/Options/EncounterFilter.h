...
#ifndef PokemonAutomation_EncounterFilter_H
#define PokemonAutomation_EncounterFilter_H
...
private:
    ...
    QComboBox* make_action_box(QWidget& parent, int& row, bool stop);
    Pokemon::NameSelectWidget* make_species_select(QWidget& parent, int& row, const std::string& slug);
