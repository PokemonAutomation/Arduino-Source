 ...
 *
 *  Use QML QQuickView. (work in progress)
 *
 *  This is hardware accelerated. But it gets hidden by the VideoOverlay.
 *
 */

#ifndef PokemonAutomation_VideoPipeline_Qt6_QQuickView_H
#define PokemonAutomation_VideoPipeline_Qt6_QQuickView_H
...
public:
    ...
    Q_INVOKABLE void registerQmlSink(QObject* qmlSink);
