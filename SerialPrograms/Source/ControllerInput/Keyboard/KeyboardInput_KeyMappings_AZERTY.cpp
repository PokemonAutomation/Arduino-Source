...
const std::map<QtKeyMap::QtKey, KeyboardKey>& KEYID_TO_HID_AZERTY(){
    static const std::map<QtKeyMap::QtKey, KeyboardKey> database{
        ...
        {Qt::Key::Key_Comma,            KeyboardKey::KEY_M},    // , key -> HID M position
        {Qt::Key::Key_N,                KeyboardKey::KEY_N},
        {Qt::Key::Key_O,                KeyboardKey::KEY_O},
        {Qt::Key::Key_P,                KeyboardKey::KEY_P},
        {Qt::Key::Key_A,                KeyboardKey::KEY_Q},    // A key -> HID Q position
        ...
        {Qt::Key::Key_Z,                KeyboardKey::KEY_W},    // Z key -> HID W position
        {Qt::Key::Key_X,                KeyboardKey::KEY_X},
        {Qt::Key::Key_Y,                KeyboardKey::KEY_Y},
        {Qt::Key::Key_W,                KeyboardKey::KEY_Z},    // W key -> HID Z position

        {Qt::Key::Key_Ampersand,        KeyboardKey::KEY_1},    // & key -> HID 1 position
        {Qt::Key::Key_Eacute,           KeyboardKey::KEY_2},    // e key -> HID 2 position
        {Qt::Key::Key_QuoteDbl,         KeyboardKey::KEY_3},    // " key -> HID 3 position
        {Qt::Key::Key_Apostrophe,       KeyboardKey::KEY_4},    // ' key -> HID 4 position
        {Qt::Key::Key_ParenLeft,        KeyboardKey::KEY_5},    // ( key -> HID 5 position
        {Qt::Key::Key_Minus,            KeyboardKey::KEY_6},    // - key -> HID 6 position
        {Qt::Key::Key_Egrave,           KeyboardKey::KEY_7},    // e key -> HID 7 position
        {Qt::Key::Key_Underscore,       KeyboardKey::KEY_8},    // _ key -> HID 8 position
        ...
        {Qt::Key::Key_ParenRight,       KeyboardKey::KEY_MINUS},        // ) KEY -> HID - position
        {Qt::Key::Key_Equal,            KeyboardKey::KEY_EQUAL},
        {Qt::Key::Key_Dead_Circumflex,  KeyboardKey::KEY_LEFT_BRACE},   // ^ KEY -> HID [ position
        {Qt::Key::Key_AsciiCircum,      KeyboardKey::KEY_LEFT_BRACE},   // ^ KEY -> HID [ position
        {Qt::Key::Key_Dollar,           KeyboardKey::KEY_RIGHT_BRACE},  // $ KEY -> HID ] position
                                                                        // Only one key there to replace two
        {Qt::Key::Key_Asterisk,         KeyboardKey::KEY_BACKSLASH},    // * KEY -> HID \ position
        {Qt::Key::Key_M,                KeyboardKey::KEY_SEMICOLON},    // m KEY -> HID ; position
        {Qt::Key::Key_Ugrave,           KeyboardKey::KEY_APOSTROPHE},   // u KEY -> HID ' position

        {Qt::Key::Key_twosuperior,      KeyboardKey::KEY_GRAVE},        // 2 KEY -> HID ` position

        {Qt::Key::Key_Semicolon,        KeyboardKey::KEY_COMMA},        // ; KEY -> HID , position
        {Qt::Key::Key_Colon,            KeyboardKey::KEY_DOT},          // : KEY -> HID . position
        {Qt::Key::Key_Exclam,           KeyboardKey::KEY_SLASH},        // ! KEY -> HID / position
