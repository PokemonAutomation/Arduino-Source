...
const std::map<Qt::Key, std::string>& QTKEY_TO_STRING(){
    static const std::map<Qt::Key, std::string> database{
...
const std::map<KeyboardKey, std::string>& KEYBOARDKEY_TO_STRING(){
    static const std::map<KeyboardKey, std::string> database{
        // Letters
        {KEY_A, "KEY_A"},
        {KEY_B, "KEY_B"},
        {KEY_C, "KEY_C"},
        ...
        {KEY_MEDIA_PREVIOUS_SONG, "KEY_MEDIA_PREVIOUS_SONG"},
        {KEY_MEDIA_NEXT_SONG, "KEY_MEDIA_NEXT_SONG"},
        ...
        {KEY_MEDIA_SCROLL_UP, "KEY_MEDIA_SCROLL_UP"},
        {KEY_MEDIA_SCROLL_DOWN, "KEY_MEDIA_SCROLL_DOWN"},
