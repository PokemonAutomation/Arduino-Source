...
std::pair<double, double> OliveDetector::olive_location(ConsoleHandle& console, SwitchControllerContext& context, ImageFloatBox box){
...
ImageFloatBox OliveDetector::get_olive_floatbox(ConsoleHandle& console, SwitchControllerContext& context, uint8_t rgb_gap, ImageFloatBox box){
