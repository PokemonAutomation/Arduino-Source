...
void move_to_start_position_for_letsgo0(ConsoleHandle& console, SwitchControllerContext& context);

void move_to_start_position_for_letsgo1(const ProgramInfo& info, ConsoleHandle& console, SwitchControllerContext& context);
