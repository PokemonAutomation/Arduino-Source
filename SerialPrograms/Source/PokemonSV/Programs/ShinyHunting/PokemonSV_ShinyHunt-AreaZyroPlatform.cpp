...
//#include "PokemonSV/Programs/PokemonSV_Navigation.h"
#include "PokemonSV_ShinyHunt-AreaZyroPlatform.h"
...
ShinyHuntAreaZyroPlatform_Descriptor::ShinyHuntAreaZyroPlatform_Descriptor()
    : SingleSwitchProgramDescriptor(
        "PokemonSV:ShinyHuntAreaZyroPlatform",
        STRING_POKEMON + " SV", "Shiny Hunt - Area Zero Platform",
        "ComputerControl/blob/master/Wiki/Programs/PokemonSV/ShinyHunt-AreaZyroPlatform.md",
...
{}
struct ShinyHuntAreaZyroPlatform_Descriptor::Stats : public StatsTracker{
    Stats()
...
std::unique_ptr<StatsTracker> ShinyHuntAreaZyroPlatform_Descriptor::make_stats() const{
...
ShinyHuntAreaZyroPlatform::ShinyHuntAreaZyroPlatform()
    : MODE(
        "<b>Mode:</b><br>"
...
bool ShinyHuntAreaZyroPlatform::clear_in_front(
    BotBaseContext& context,
    bool throw_ball_if_bubble,
    std::function<void(BotBaseContext& context)>&& command
){
//    ShinyHuntAreaZyroPlatform_Descriptor::Stats& stats = env.current_stats<ShinyHuntAreaZyroPlatform_Descriptor::Stats>();
...
void ShinyHuntAreaZyroPlatform::run_path0(BotBaseContext& context){
    ConsoleHandle& console = m_env->console;
...
void ShinyHuntAreaZyroPlatform::run_path1(BotBaseContext& context){
    ConsoleHandle& console = m_env->console;
...
void ShinyHuntAreaZyroPlatform::run_path2(BotBaseContext& context){
    ConsoleHandle& console = m_env->console;
...
void ShinyHuntAreaZyroPlatform::run_traversal(BotBaseContext& context){
    switch (PATH0){
    case Path::PATH0:
        run_path0(context);
        break;
...
void ShinyHuntAreaZyroPlatform::on_shiny_encounter(
    BotBaseContext& context, EncounterWatcher& encounter_watcher
){
    ShinyHuntAreaZyroPlatform_Descriptor::Stats& stats = m_env->current_stats<ShinyHuntAreaZyroPlatform_Descriptor::Stats>();
...
void ShinyHuntAreaZyroPlatform::run_state(BotBaseContext& context){
    ShinyHuntAreaZyroPlatform_Descriptor::Stats& stats = m_env->current_stats<ShinyHuntAreaZyroPlatform_Descriptor::Stats>();
...
void ShinyHuntAreaZyroPlatform::program(SingleSwitchProgramEnvironment& env, BotBaseContext& context){
    m_env = &env;
