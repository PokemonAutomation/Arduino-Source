...
void checkpoint_39(
    ...
    [&](size_t attempt_number){         
        ...
        // section 2
        realign_player(env.program_info(), env.console, context, PlayerRealignMode::REALIGN_NEW_MARKER, 255, 230, 960ms);
...
void checkpoint_40(
    ...
    [&](size_t attempt_number){         
        ...
        realign_player(env.program_info(), env.console, context, PlayerRealignMode::REALIGN_NEW_MARKER, 255, 180, 720ms);
        ...
        [&](const ProgramInfo& info, VideoStream& stream, ProControllerContext& context){
            realign_player(env.program_info(), env.console, context, PlayerRealignMode::REALIGN_NEW_MARKER, 255, 160, 320ms);
        });      
        overworld_navigation(env.program_info(), env.console, context, 
