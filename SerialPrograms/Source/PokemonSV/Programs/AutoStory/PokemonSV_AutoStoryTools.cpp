...
void clear_tutorial(ConsoleHandle& console, ControllerContext& context, uint16_t seconds_timeout){
...
void change_settings(SingleSwitchProgramEnvironment& env, ControllerContext& context,  Language language, bool use_inference){
...
void press_A_until_dialog(const ProgramInfo& info, ConsoleHandle& console, ControllerContext& context, uint16_t seconds_between_button_presses){
    ...
    int ret = run_until<ControllerContext>(
        console, context,
        [seconds_between_button_presses](ControllerContext& context){
