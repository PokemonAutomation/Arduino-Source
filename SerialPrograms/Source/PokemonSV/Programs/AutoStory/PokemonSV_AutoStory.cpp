...
void AutoStory::test_checkpoints(
    ...
    // checkpoint_list.push_back([&](){checkpoint_01(env, context, notif_status_update, stats, checkpoint_text, language);});
    // checkpoint_list.push_back([&](){checkpoint_02(env, context, notif_status_update, stats);});
    // checkpoint_list.push_back([&](){checkpoint_03(env, context, notif_status_update, stats, checkpoint_text, language, starter_choice);});
    ...
    // checkpoint_list.push_back([&](){checkpoint_87(env, context, notif_status_update, stats, checkpoint_text, language, starter_choice);});
