...
JoinReportRow::JoinReportRow(Language p_language, bool p_enabled)
    ...
    , language(LockWhileRunning::UNLOCK_WHILE_RUNNING, language_data(p_language).name)
    , enabled(LockWhileRunning::UNLOCK_WHILE_RUNNING, p_enabled)
{
...
RaidJoinReportOption::RaidJoinReportOption()
    : GroupOption("Join Reports:", LockWhileRunning::UNLOCK_WHILE_RUNNING, true, true)
    , text(
