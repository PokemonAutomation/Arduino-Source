...
bool eat_egg_sandwich_at_picnic(ProgramEnvironment& env, ConsoleHandle& console,
    ControllerContext& context, EggSandwichType sandwich_type, Language language);
...
void collect_eggs_after_sandwich(const ProgramInfo& info, ConsoleHandle& console, ControllerContext& context,
