...
private:
    ...
    void run_item_printer_rng_automode(SingleSwitchProgramEnvironment& env, ControllerContext& context, ItemPrinterRNG_Descriptor::Stats& stats);

    void run_item_printer_rng(SingleSwitchProgramEnvironment& env, ControllerContext& context, ItemPrinterRNG_Descriptor::Stats& stats);
