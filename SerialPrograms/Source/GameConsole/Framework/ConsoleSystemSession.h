...
public:
    ...
    virtual size_t controllers() const override{ return m_controllers.size(); }
    virtual ControllerSession& controller(size_t index) override{ return m_controllers[index].session; }
