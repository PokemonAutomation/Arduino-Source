...
public:
    ImageFilterRunner_Rgb32Range_x64_AVX2(uint32_t mins, uint32_t maxs, uint32_t replacement, bool invert)
...
size_t filter_rgb32_range_x64_AVX2(
    ...
    ImageFilterRunner_Rgb32Range_x64_AVX2 filter(mins, maxs, replacement, invert);
