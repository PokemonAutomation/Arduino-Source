...
public:
    ImageFilterRunner_Rgb32Range_x64_SSE42(
...
size_t filter_rgb32_range_x64_SSE42(
    ...
    ImageFilterRunner_Rgb32Range_x64_SSE42 filter(mins, maxs, replacement, replace_color_within_range);
...
public:
    ToBlackWhite_RgbRange_x64_SSE42(uint32_t mins, uint32_t maxs, bool in_range_black)
        ...
        , m_count(_mm_setzero_si128())
    {}
    ToBlackWhite_RgbRange_x64_SSE42(ToBlackWhiteRgb32RangeFilter& filter)
        : ToBlackWhite_RgbRange_x64_SSE42(filter.mins, filter.maxs, filter.in_range_black)
    {}
...
void to_blackwhite_rgb32_range_x64_SSE42(
    ...
    filter_per_pixel<ToBlackWhite_RgbRange_x64_SSE42>(
        image, bytes_per_row, width, height, filter, filter_count
    );
}
