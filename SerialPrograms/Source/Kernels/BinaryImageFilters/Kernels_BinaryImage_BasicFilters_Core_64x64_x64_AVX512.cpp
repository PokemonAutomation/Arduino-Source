...
#include "Kernels_BinaryImage_BasicFilters_64x64_x64_AVX512.h"
...
void filter_rgb32_64x64_x64_AVX512(
    ...
    filter_rgb32(static_cast<const PackedBinaryMatrix_64x64_x64_AVX512&>(matrix).get(), image, bytes_per_row, filter);
}
