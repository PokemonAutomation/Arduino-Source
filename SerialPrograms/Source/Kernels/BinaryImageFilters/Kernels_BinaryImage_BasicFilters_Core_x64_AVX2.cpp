...
void compress_rgb32_to_binary_range_x64_AVX2(
    ...
    compress_rgb32_to_binary(
        image, bytes_per_row,
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix0).get(), compressor0
    );
}
void compress2_rgb32_to_binary_range_x64_AVX2(
    ...
    compress2_rgb32_to_binary(
        image, bytes_per_row,
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix0).get(), compressor0,
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix1).get(), compressor1
    );
}
void compress4_rgb32_to_binary_range_x64_AVX2(
    ...
    compress4_rgb32_to_binary(
        ...
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix0).get(), compressor0,
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix1).get(), compressor1,
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix2).get(), compressor2,
        static_cast<PackedBinaryMatrix_x64_AVX2&>(matrix3).get(), compressor3
    );
}
void compress_rgb32_to_binary_range_x64_AVX2(
    const uint32_t* image, size_t bytes_per_row,
    ...
    compress_rgb32_to_binary<PackedBinaryMatrix_x64_AVX2, Compressor_RgbRange_x64_AVX2>(
...
void filter_rgb32_x64_AVX2(
    ...
    filter_rgb32(static_cast<const PackedBinaryMatrix_x64_AVX2&>(matrix).get(), image, bytes_per_row, filter);
}
