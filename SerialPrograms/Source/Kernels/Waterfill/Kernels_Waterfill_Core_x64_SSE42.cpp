...
bool Waterfill_x64_SSE42::find_bit(size_t& x, size_t& y, const BinaryTile_SSE42& tile){
...
void Waterfill_x64_SSE42::boundaries(
...
__m128i Waterfill_x64_SSE42::popcount_indexsum(__m128i& sum_index, __m128i x){
    //  1 -> 2
    __m128i sum_high;
...
uint64_t Waterfill_x64_SSE42::popcount_sumcoord(
...
void Waterfill_x64_SSE42::Waterfill_expand(const BinaryTile_SSE42& m, BinaryTile_SSE42& x){
    __m128i x0 = x.vec[0];
    __m128i x1 = x.vec[1];
    __m128i x2 = x.vec[2];
    __m128i x3 = x.vec[3];
...
bool Waterfill_x64_SSE42::Waterfill_touch_top(const BinaryTile_SSE42& mask, BinaryTile_SSE42& tile, const BinaryTile_SSE42& border){
...
bool Waterfill_x64_SSE42::Waterfill_touch_bottom(const BinaryTile_SSE42& mask, BinaryTile_SSE42& tile, const BinaryTile_SSE42& border){
...
bool Waterfill_x64_SSE42::Waterfill_touch_left(const BinaryTile_SSE42& mask, BinaryTile_SSE42& tile, const BinaryTile_SSE42& border){
...
bool Waterfill_x64_SSE42::Waterfill_touch_right(const BinaryTile_SSE42& mask, BinaryTile_SSE42& tile, const BinaryTile_SSE42& border){
    __m128i changed = _mm_setzero_si128();
    for (size_t c = 0; c < 4; c++){
        __m128i available = _mm_andnot_si128(tile.vec[c], mask.vec[c]);
