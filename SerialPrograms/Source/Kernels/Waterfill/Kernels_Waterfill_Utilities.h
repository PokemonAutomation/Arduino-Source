...
#ifndef PokemonAutomation_Kernels_Waterfill_Process_H
#define PokemonAutomation_Kernels_Waterfill_Process_H
...
// ...
std::pair<PackedBinaryMatrix2, size_t> remove_center_pixels(const WaterfillObject& object, size_t num_removed_pixels_threshold);
...
void draw_object_on_image(const WaterfillObject& object, const uint32_t& color, QImage& image, size_t offset_x, size_t offset_y);
