...
bool Waterfill_Default::find_bit(size_t& x, size_t& y, const BinaryTile_Default& tile){
...
void Waterfill_Default::boundaries(
...
uint64_t Waterfill_Default::popcount_indexsum(uint64_t& sum_index, uint64_t x){
    //  1 -> 2
    uint64_t sum_high;
...
uint64_t Waterfill_Default::popcount_sumcoord(
...
void Waterfill_Default::Waterfill_expand(const BinaryTile_Default& m, BinaryTile_Default& x){
    uint64_t x0 = x.vec[0];
    uint64_t x1 = x.vec[1];
    uint64_t x2 = x.vec[2];
    uint64_t x3 = x.vec[3];
...
bool Waterfill_Default::Waterfill_touch_top(const BinaryTile_Default& mask, BinaryTile_Default& tile, const BinaryTile_Default& border){
...
bool Waterfill_Default::Waterfill_touch_bottom(const BinaryTile_Default& mask, BinaryTile_Default& tile, const BinaryTile_Default& border){
...
bool Waterfill_Default::Waterfill_touch_left(const BinaryTile_Default& mask, BinaryTile_Default& tile, const BinaryTile_Default& border){
    bool changed = false;
    for (size_t c = 0; c < 4; c++){
...
bool Waterfill_Default::Waterfill_touch_right(const BinaryTile_Default& mask, BinaryTile_Default& tile, const BinaryTile_Default& border){
    bool changed = false;
    for (size_t c = 0; c < 4; c++){
        uint64_t available = mask.vec[c] & ~tile.vec[c];
        uint64_t new_bits = available & (border.vec[c] << 63);
