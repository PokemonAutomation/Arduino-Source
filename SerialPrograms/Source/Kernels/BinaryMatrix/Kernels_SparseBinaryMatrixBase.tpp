...
#ifndef PokemonAutomation_Kernels_SparseBinaryMatrixBase_TPP
#define PokemonAutomation_Kernels_SparseBinaryMatrixBase_TPP
...
SparseBinaryMatrixBase<Tile>::~SparseBinaryMatrixBase(){}
template <typename Tile>
SparseBinaryMatrixBase<Tile>::SparseBinaryMatrixBase(SparseBinaryMatrixBase&& x)
...
template <typename Tile>
void SparseBinaryMatrixBase<Tile>::operator=(SparseBinaryMatrixBase&& x){
    m_logical_width = x.m_logical_width;
    m_logical_height = x.m_logical_height;
    m_tile_width = x.m_tile_width;
    m_tile_height = x.m_tile_height;
...
template <typename Tile>
SparseBinaryMatrixBase<Tile>::SparseBinaryMatrixBase(const SparseBinaryMatrixBase& x)
    : m_logical_width(x.m_logical_width)
    , m_logical_height(x.m_logical_height)
    , m_tile_width(x.m_tile_width)
    , m_tile_height(x.m_tile_height)
...
{}
template <typename Tile>
SparseBinaryMatrixBase<Tile>::SparseBinaryMatrixBase(size_t width, size_t height)
...
{}
template <typename Tile>
void SparseBinaryMatrixBase<Tile>::clear(){
    m_logical_width = 0;
    m_logical_height = 0;
    m_tile_width = 0;
    m_tile_height = 0;
...
template <typename Tile>
void SparseBinaryMatrixBase<Tile>::set_data(std::map<TileIndex, Tile> data){
...
template <typename Tile>
std::string SparseBinaryMatrixBase<Tile>::dump() const{
    return dump(0, 0, m_logical_width, m_logical_height);
}
template <typename Tile>
std::string SparseBinaryMatrixBase<Tile>::dump(
...
template <typename Tile>
PackedBinaryMatrixBase<Tile> SparseBinaryMatrixBase<Tile>::submatrix(
    size_t x, size_t y,
    size_t width, size_t height
) const{
    PackedBinaryMatrixBase<Tile> ret(width, height);
