...
#include "Kernels_BinaryMatrix_Arch_Default.h"

namespace PokemonAutomation{
namespace Kernels{


template class PackedBinaryMatrixCore<BinaryTile_Default>;
template class SparseBinaryMatrixCore<BinaryTile_Default>;
template class PackedBinaryMatrix_t<BinaryTile_Default>;
template class SparseBinaryMatrix_t<BinaryTile_Default>;
