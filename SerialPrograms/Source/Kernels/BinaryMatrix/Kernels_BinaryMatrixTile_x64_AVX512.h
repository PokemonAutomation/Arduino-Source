...
struct BinaryTile_AVX512{
    static constexpr BinaryMatrixType TYPE = BinaryMatrixType::AVX512;
...
public:
    PA_FORCE_INLINE BinaryTile_AVX512(){
        set_zero();
    }
...
public:
    ...
    void copy_to_shift_pp(BinaryTile_AVX512& tile, size_t shift_x, size_t shift_y) const{
        //  (+x, +y)
    ...
    void copy_to_shift_np(BinaryTile_AVX512& tile, size_t shift_x, size_t shift_y) const{
        //  (-x, +y)
        __m512i shift = _mm512_set1_epi64(shift_x);
        const uint64_t* src = (const uint64_t*)vec;
        uint64_t* dest = (uint64_t*)tile.vec;
    ...
    void copy_to_shift_pn(BinaryTile_AVX512& tile, size_t shift_x, size_t shift_y) const{
        //  (+x, -y)
        __m512i shift = _mm512_set1_epi64(shift_x);
        const uint64_t* src = (const uint64_t*)vec;
        uint64_t* dest = (uint64_t*)tile.vec;
    ...
    void copy_to_shift_nn(BinaryTile_AVX512& tile, size_t shift_x, size_t shift_y) const{
        //  (-x, -y)
        __m512i shift = _mm512_set1_epi64(shift_x);
        const uint64_t* src = (const uint64_t*)vec;
        uint64_t* dest = (uint64_t*)tile.vec;
