...
bool ShinyHuntShaymin::start_encounter(SingleSwitchProgramEnvironment& env, ControllerContext& context) const{
...
void ShinyHuntShaymin::program(SingleSwitchProgramEnvironment& env, ControllerContext& context){
