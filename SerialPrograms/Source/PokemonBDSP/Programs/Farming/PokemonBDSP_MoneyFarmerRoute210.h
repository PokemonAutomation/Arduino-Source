...
private:
    ...
    bool heal_after_battle_and_return(SingleSwitchProgramEnvironment& env, ConsoleHandle& console, SwitchControllerContext& context, uint8_t pp0[4], uint8_t pp1[4]);
    ...
    void fly_to_center_heal_and_return(Logger& logger, SwitchControllerContext& context, uint8_t pp0[4], uint8_t pp1[4]);
