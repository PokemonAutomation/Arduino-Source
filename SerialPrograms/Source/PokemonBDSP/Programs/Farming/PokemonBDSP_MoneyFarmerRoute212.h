...
private:
    ...
    bool heal_after_battle_and_return(SingleSwitchProgramEnvironment& env, BotBaseContext& context, ConsoleHandle& console, uint8_t pp[4]);
    // Starting in front of the Hearthome Pokecenter, heal and return
    // to the old couple.
    void heal_at_center_and_return(BotBaseContext& context, ConsoleHandle& console, uint8_t pp[4]);
