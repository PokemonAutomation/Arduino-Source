    ...
    while (true){
        ...
        case 1:
            if (results.result == CatchResult::POKEMON_CAUGHT){
                throw OperationFailedException(true, console, "BasicCatcher: Found receive pokemon screen two times.", true);
            }
        ...
        case 2:
            ...
            if (num_learned_moves == 100){
                throw OperationFailedException(true, console, "BasicCatcher: Learn new move attempts reach 100.", true);
            }
