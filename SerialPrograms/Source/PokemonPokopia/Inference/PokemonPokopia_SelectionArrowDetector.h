...
#ifndef PokemonAutomation_PokemonPokopia_SelectionArrowDetector_H
#define PokemonAutomation_PokemonPokopia_SelectionArrowDetector_H
...
// Note: there are two slightly different colored arrows
// A single filter currently is capturing both and using the same template
// If there are issues, then use both templates
