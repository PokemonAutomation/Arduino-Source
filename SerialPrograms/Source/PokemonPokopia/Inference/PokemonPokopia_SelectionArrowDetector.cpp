...
#include "PokemonPokopia_SelectionArrowDetector.h"
...
public:
    ...
    static const SelectionArrowMatcher& RIGHT_ARROW(){
        static SelectionArrowMatcher matcher("PokemonPokopia/SelectionArrowRight.png");
        return matcher;
    }
    static const SelectionArrowMatcher& DOWN_ARROW(){
        static SelectionArrowMatcher matcher("PokemonPokopia/SelectionArrowDown.png");
        return matcher;
    }
};
