...
BattleMenuDetector::BattleMenuDetector(LoggerQt& logger, VideoOverlay& overlay, bool stop_on_detected)
...
bool BattleMenuDetector::process_frame(
    ...
    const ImageStats stroke_left = image_stats(extract_box_shallow(frame, m_pokemon_stroke_bg_left));
    ...
    const ImageStats stroke_right = image_stats(extract_box_shallow(frame, m_pokemon_stroke_bg_right));
