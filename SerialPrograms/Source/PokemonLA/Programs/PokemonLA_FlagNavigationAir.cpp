    ...
    , m_last_flag_print(WallClock::min())
{
    ...
    *this += m_dialog_detector;
    ...
    auto find_flag = [this](BotBaseContext& context){
...
bool FlagNavigationAir::run_state(AsyncCommandSession<BotBase>& commands, WallClock timestamp){
...
bool FlagNavigationAir::run_flying(AsyncCommandSession<BotBase>& commands, WallClock timestamp){
...
bool FlagNavigationAir::run_climbing(AsyncCommandSession<BotBase>& commands, WallClock timestamp){
