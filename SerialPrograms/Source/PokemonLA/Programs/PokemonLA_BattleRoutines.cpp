...
void mash_A_until_end_of_battle(ConsoleHandle& console, SwitchControllerContext& context){
...
size_t switch_pokemon(ConsoleHandle& console, SwitchControllerContext& context, size_t pokemon_to_switch_to, size_t max_num_pokemon){
...
void use_move_blindly(ConsoleHandle& console, SwitchControllerContext& context, MoveStyle style, size_t cur_pokemon, size_t cur_move){
    // Select move styles
...
bool use_move(ConsoleHandle& console, SwitchControllerContext& context, size_t cur_pokemon, size_t cur_move, MoveStyle style, bool check_success){
...
void use_next_move_with_pp(ConsoleHandle& console, SwitchControllerContext& context, size_t cur_pokemon, size_t& cur_move){
