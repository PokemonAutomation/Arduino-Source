...
void ApplyGrits::ApplyGritsOnOnePokemon(SingleSwitchProgramEnvironment& env, ControllerContext& context, size_t pokemon_index){
...
void ApplyGrits::program(SingleSwitchProgramEnvironment& env, ControllerContext& context){
