...
template class RegisterUiStateQtWidget<ML::LabelImages_Widget>;
    ...
    , m_display_session(m_program.m_display_session)
{
    ...
    ConfigWidget* label_type_widget = ConfigWidget::make_from_option(session.LABEL_TYPE, scroll_inner);
    annotation_row->addWidget(&label_type_widget->widget(), 0);

    ConfigWidget* pokemon_label_widget = ConfigWidget::make_from_option(session.FORM_LABEL, scroll_inner);
    annotation_row->addWidget(&pokemon_label_widget->widget(), 2);
    ConfigWidget* custom_label_widget = ConfigWidget::make_from_option(session.CUSTOM_SET_LABEL, scroll_inner);
    annotation_row->addWidget(&custom_label_widget->widget(), 2);
    ConfigWidget* manual_input_label_widget = ConfigWidget::make_from_option(session.MANUAL_LABEL, scroll_inner);
    ...
    // ConfigWidget* gpu_checkbox_widget = ConfigWidget::make_from_option(session.USE_GPU_FOR_EMBEDDER_SESSION, scroll_inner);
    ...
    ConfigWidget* selected_color_choice_widget = ConfigWidget::make_from_option(session.SELECTED_ANNO_COLOR, scroll_inner);
    ...
    ConfigWidget* unselected_color_choice_widget = ConfigWidget::make_from_option(session.UNSELECTED_ANNO_COLOR, scroll_inner);
    ...
    ConfigWidget* current_drawn_box_widget = ConfigWidget::make_from_option(session.CURRENT_DRAWN_BOX, scroll_inner);
