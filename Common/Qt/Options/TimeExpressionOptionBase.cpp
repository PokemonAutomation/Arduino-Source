...
template <typename Type>
bool TimeExpressionOptionBase<Type>::is_valid() const{
...
template <typename Type>
bool TimeExpressionOptionBase<Type>::set_value(const QString& str){
    m_current = str;
    return update();
}
template <typename Type>
...
template <typename Type>
bool TimeExpressionOptionBase<Type>::update(){
