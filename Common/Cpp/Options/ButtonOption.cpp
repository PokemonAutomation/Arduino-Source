...
ButtonCell::ButtonCell(const ButtonCell& x)
    : UiState<ButtonCell, ConfigOption>(x)
    , m_data(
        CONSTRUCT_TOKEN,
        x.m_data->m_state,
        x.m_data->text(),
...
ButtonCell::ButtonCell(
    ...
    : UiState<ButtonCell, ConfigOption>(LockMode::UNLOCK_WHILE_RUNNING)
...
ButtonOption::ButtonOption(
    ...
    : UiState<ButtonOption, ButtonCell>(std::move(text), button_height, text_size)
...
ButtonOption::ButtonOption(
    ...
    : UiState<ButtonOption, ButtonCell>(state, std::move(text), button_height, text_size)
    , m_data(CONSTRUCT_TOKEN, std::move(label))
{}
