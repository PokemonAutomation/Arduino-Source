...
#include "NativePrograms/DeviceFramework/HardwareLED.h"
...
#include "NativePrograms/NintendoSwitch/Framework/uart.h"
#include "NativePrograms/NintendoSwitch/Framework/HardwareSerial.h"
